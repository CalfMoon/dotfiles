...
(
  ...
  (font-lock-variable-name-face (:foreground thm-br-magenta))
  (font-lock-function-name-face (:foreground thm-cyan))
  (font-lock-constant-face   (:foreground thm-br-green))
  (font-lock-string-face     (:foreground thm-br-green))
  (font-lock-builtin-face    (:foreground thm-br-cyan))
  (font-lock-comment-face    (:foreground thm-comment))
  (css-property              (:foreground thm-br-green))
  (css-selector              (:foreground thm-cyan))
